...
System.register("client/clientMain", ["AvalonCore/socketCore"], function (exports_2, context_2) {
    "use strict";
    ...
    function getStartPacket(name) {
        var ret = {
            type: socketCore_1.msgT.P_JOIN,
            name: name
        };
        return JSON.stringify(ret);
    }
    var socketCore_1, websocket;
    return {
        setters: [
            function (socketCore_1_1) {
                socketCore_1 = socketCore_1_1;
            }
        ],
        execute: function () {
